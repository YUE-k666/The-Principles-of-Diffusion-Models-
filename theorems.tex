...
% Problem Setup
% ============================
\newtcbtheorem[number within=section]{myproblem}{问题设置}
{
    enhanced,
    frame hidden,
    titlerule=0mm,
...
% Research Problem
% ============================
\newtcbtheorem{myresearchproblem}{研究问题}
{
    enhanced,
    frame hidden,
    titlerule=0mm,
...
\newtcbtheorem[use counter=mytheorem, number within=section]{mytheorem}{定理}{
    enhanced,
    frame hidden,
    titlerule=0.0mm,
    fonttitle=\sffamily\bfseries,
...
\newtcbtheorem[use counter=mytheorem, number within=section]{myproposition}{命题}
{ 
  enhanced,
  frame hidden,
  titlerule=0mm,
...
\newtcbtheorem[use counter from=mydefinition]{myclaim}{断言}
{
    enhanced,
    frame hidden,
    titlerule=0mm,
